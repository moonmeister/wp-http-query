...
| Core patch (`QUERY`) | Blocked on ADRs 0001, 0002. Under the option D lean the order is fixed: gap 3 ([#2](../../issues/2)) → [Trac#65905](https://core.trac.wordpress.org/ticket/65905) → ADR 0003 cache safety ([#18](../../issues/18), **now gating**, previously did not) → [#38](../../issues/38) → propose D |
